...
import com.student.management.gui.StudentManagementGUI; // Import the GUI class

public class MainApp {
    public static void main(String[] args) {
        try {
            // Start the Student Management GUI
            new StudentManagementGUI(); // This will launch the GUI
            ...
            Course coreCourse = CourseFactory.createCourse("core", 1, "Math 101");
            Course electiveCourse = CourseFactory.createCourse("elective", 2, "History 201");
