...
public class CourseRegistrationSystem {
    ...
    public boolean registerCourse(String studentId, CoreCourse course) {
        ...
        // After registering the course, we can initialize grades for the student.
        GradeProcessingSystem.getInstance().addGrade(studentId, course.getCourseName(), 0.0); // Initial grade 0
        return true;
    }
